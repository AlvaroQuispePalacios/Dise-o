...
namespace Prueba
{
    public partial class FormAlumnos : Form
    {
        ...
        {
            // TODO: esta línea de código carga datos en la tabla 'dbSistemaDataSet.Alumnos' Puede moverla o quitarla según sea necesario.
            this.alumnosTableAdapter.Fill(this.dbSistemaDataSet.Alumnos);
